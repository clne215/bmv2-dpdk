...
class SimpleSwitch : public Switch {
 ...
 public:
  ...
  //dpdk send packet function
  void simple_switch_dpdk_send_packets(uint32_t port);
  //others output buffer
  Queue<std::unique_ptr<Packet> > haha_test;
  Queue<std::unique_ptr<Packet> > dpdk_output_buffer_0;
  Queue<std::unique_ptr<Packet> > dpdk_output_buffer_1;
  Queue<std::unique_ptr<Packet> > dpdk_output_buffer_2;
  Queue<std::unique_ptr<Packet> > dpdk_output_buffer_3;
  Queue<std::unique_ptr<Packet> > dpdk_output_buffer_4;
  Queue<std::unique_ptr<Packet> > dpdk_output_buffer_5;
  Queue<std::unique_ptr<Packet> > dpdk_output_buffer_6;
  Queue<std::unique_ptr<Packet> > dpdk_output_buffer_7;
  Queue<std::unique_ptr<Packet> > dpdk_output_buffer_8;
  Queue<std::unique_ptr<Packet> > dpdk_output_buffer_9;

  //define output buffer lock
  std::mutex dpdk_output_buffer_mutex;
 private:
